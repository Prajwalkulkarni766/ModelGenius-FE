...
import { Paper, Typography, Box, CircularProgress, IconButton, Tooltip, Snackbar } from "@mui/material";
  ...
  useEffect(() => {
    const fetchCode = async () => {
      if (!projectId || !modelId) {
        showSnackbar("Missing project or model ID", "error");
        setLoading(false);
        return;
      }
      ...
      if (code) {
        ...
        showSnackbar("Failed to fetch Python code. Please ensure the model is configured.", "error");
      }
      setLoading(false);
    };
